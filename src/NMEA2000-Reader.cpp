...
// Version 0.2 03.04.2023, G. Sebb, add Wind
...
void HandleWind(const tN2kMsg &N2kMsg) {
  ...
  if ( ParseN2kWindSpeed(N2kMsg, SID, WindSpeed, WindAngle, WindReference) ) {
    Serial.printf("PGN130306: Speed: %3.1f m/s Angle: %3.1f °\n", (WindSpeed), RadToDeg(WindAngle));
  }
}
...
void HandleEnvironment(const tN2kMsg &N2kMsg) {
  ...
  //tN2EnvironmentReference EnvironmentReference;

  if ( ParseN2kOutsideEnvironmentalParameters(N2kMsg, SID, WaterTemperature, OutsideAmbientAirTemperature, AtmosphericPressure) ) {
    Serial.printf("PGN130310: WaterTep: %3.1f °C OutsideTemp: %3.1f °C Pressue: %3.2f hPa\n", (WaterTemperature), (OutsideAmbientAirTemperature), (AtmosphericPressure));
  }
}
...
void MyHandleNMEA2000Msg(const tN2kMsg &N2kMsg) {
  ...
  switch (N2kMsg.PGN) {
    ...
    Serial.print("Handle Heading\n");
    case 128259L: HandleBoatSpeed(N2kMsg);
    Serial.print("Handle Speed\n");
    case 130306L: HandleWind(N2kMsg);
    Serial.print("Handle Wind\n");
    case 130310L: HandleEnvironment(N2kMsg);
    Serial.print("Handle Environement\n");
    default: 
    Serial.print("nichts zu sehen\n");
  }
}
